    ...
    <div class="py-6">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 shadow sm:rounded-lg p-6">
                <form action="{{ route('question-types.update', $questionType) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                name="type"
                                id="type"
                                value="{{ old('type', $questionType->type) }}"
                                required
                        ...
                        <div>
                            ...
                            <input
                                ...
                                name="typecode"
                                id="typecode"
                                value="{{ old('typecode', $questionType->typecode) }}"
                                required
                                class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:text-white"
                        ...
                        <div>
                            ...
                            <input
                                ...
                                name="count"
                                id="count"
                                value="{{ old('count', $questionType->count) }}"
                                min="0"
                                class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:text-white"
                                placeholder="0"
                            >
                        ...
                        <div>
                            ...
                            <input
                                ...
                                name="timer"
                                id="timer"
                                value="{{ old('timer', $questionType->timer) }}"
                                min="0"
                                class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:text-white"
                        ...
                        <div>
                            ...
                            <input
                                ...
                                name="order"
                                id="order"
                                value="{{ old('order', $questionType->order) }}"
                                min="0"
                                class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:text-white"
                                placeholder="0"
                            >
                        ...
                        <div>
                            ...
                            >{{ old('description', $questionType->description) }}</textarea>
                            @error('description')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
