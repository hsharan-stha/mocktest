    ...
    <div class="py-6">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 shadow sm:rounded-lg p-6">
                <form action="{{ route('question-type-sub-sections.update', $questionTypeSubSection) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            >
                                ...
                                @foreach($questionTypes as $qt)
                                    <option value="{{ $qt->id }}" {{ old('question_type_id', $questionTypeSubSection->question_type_id) == $qt->id ? 'selected' : '' }}>
                                        {{ $qt->type }} ({{ $qt->typecode }})
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                name="name"
                                id="name"
                                value="{{ old('name', $questionTypeSubSection->name) }}"
                                required
                                class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:text-white"
                        ...
                        <div>
                            ...
                            <input
                                ...
                                name="count"
                                id="count"
                                value="{{ old('count', $questionTypeSubSection->count ?? 0) }}"
                                min="0"
                                class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:text-white"
                                placeholder="0"
                            >
                        ...
                        <div>
                            ...
                            <input
                                ...
                                name="order"
                                id="order"
                                value="{{ old('order', $questionTypeSubSection->order) }}"
                                min="0"
                                class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:text-white"
                                placeholder="0"
                            >
                        ...
                        <div>
                            ...
                            >{{ old('description', $questionTypeSubSection->description) }}</textarea>
                            @error('description')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
