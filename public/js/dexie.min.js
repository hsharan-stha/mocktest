(function (e, t) {
    "object" == typeof exports && "undefined" != typeof module
        ...
        ? define(t)
        : ((e =
              "undefined" != typeof globalThis ? globalThis : e || self).Dexie =
              t());
})(this, function () {
    "use strict";
    var s = function (e, t) {
        ...
        return i === G
            ...
            : function () {
                  ...
                  if (e && "function" == typeof e.then) {
                      for (
                          var t = this, n = arguments.length, r = new Array(n);
                          n--;
    ...
    var xe = {
        get: function () {
            ...
            function e(n, r) {
                ...
                return (
                    this._consoleTask && (e._consoleTask = this._consoleTask), e
                );
            }
    ...
    r(_e.prototype, {
        ...
        r(_e, {
            all: function () {
                var o = B.apply(null, arguments).map(ze);
    ...
    function Le() {
        return Te.id || (Te.id = ++Be), ++Te.awaits, (Te.echoes += ue), Te.id;
    }
    function Ue() {
        return (
            !!Te.awaits &&
            (0 == --Te.awaits && (Te.id = 0), (Te.echoes = Te.awaits * ue), !0)
        );
    }
    function ze(e) {
        return Te.echoes && e && e.constructor === se
            ? (Le(),
              e.then(
                  function (e) {
                      return Ue(), e;
    ...
    function Ve() {
        var e = Ie[Ie.length - 1];
        Ie.pop(), We(e, !1);
    }
    function We(e, t) {
        var n,
            r = me;
        (t ? !Te.echoes || (Re++ && e === me) : !Re || (--Re && e === me)) ||
            queueMicrotask(
                t
                    ? function (e) {
                          ++Fe,
                              (Te.echoes && 0 != --Te.echoes) ||
                                  (Te.echoes = Te.awaits = Te.id = 0),
                              Ie.push(me),
                              We(e, !0);
                      }.bind(null, e)
                    : Ve
                ...
                var s =
                    n && n.db._novip === this.db._novip
                        ...
                        : (function t(n, r, i, o) {
                              if (
                                  n.idbdb &&
                                  (n._state.openComplete ||
                                      me.letThrough ||
                                      n._vip)
                              ) {
                                  var a = n._createTransaction(
                                      r,
                                      i,
                                      n._dbSchema
                                  );
                              ...
                              if (n._state.openComplete)
                                  return Xe(
                                      new Y.DatabaseClosed(n._state.dbOpenError)
                                  );
    ...
    function jt(e, t, n) {
        e = e instanceof Tt ? new e.Collection(e) : e;
    ...
    var Tt =
        ...
        (Bt.prototype.inAnyRange = function (e, t) {
            ...
            if (
                !e.every(function (e) {
                    return (
                        void 0 !== e[0] && void 0 !== e[1] && u(e[0], e[1]) <= 0
                    );
                })
            )
                return jt(
                ...
                return (
                    ...
                    (t.oncomplete = qe(function () {
                        (n.active = !1),
                            n._resolve(),
                            "mutatedParts" in t &&
                                Nt.storagemutated.fire(t.mutatedParts);
                    })),
                    this
                );
            }),
                                                ...
                                                t.push(function (e) {
                                                    s.idbdb.objectStoreNames.contains(
                                                        ...
                                                        (Math.ceil(
                                                            ...
                                                            ? (s.idbdb.deleteObjectStore(
                                                                  "$meta"
                                                              ),
                                                              delete s._dbSchema
                                                                  .$meta,
                                                              (s._storeNames =
                                                                  s._storeNames.filter(
                                                                      function (
                                                                          e
                                                                      ) {
                                                                          return (
    ...
    function Tn(f) {
        ...
        function y() {
            return new _e(function (s, n) {
                ...
                (l.onerror = It(n)),
                    (l.onblocked = qe(f._fireOnBlocked)),
                    (l.onupgradeneeded = qe(function (e) {
                        var t;
                        (v = l.transaction),
                            h.autoSchema && !f._options.allowEmptyDB
                                ? ((l.onerror = Rt),
                                  v.abort(),
                                  l.result.close(),
                                  ((t = r.deleteDatabase(c)).onsuccess =
                                      t.onerror =
                                          qe(function () {
                                              n(
                    ...
                    (l.onsuccess = qe(function () {
                        ...
                        et.push(f),
                            (o.onversionchange = qe(function (e) {
                ...
                table: function (d) {
                    var p = r.table(d),
                        ...
                        m =
                            ...
                            e.filter(function (e) {
                                return (
                                    e.compound && e.keyPath.includes(v.keyPath)
                                );
                            }),
                        t = w(w({}, p), {
                            mutate: function (i) {
                    ...
                    return w(w({}, l), {
                        ...
                        query: function (t) {
                            ...
                            var i =
                                ...
                                o = (function (e, t, n, r) {
                                    var i =
                                        Sn["idb://".concat(e, "/").concat(t)];
                                    if (!i) return [];
                                    if (!(t = i.queries[n]))
                                        return [null, !1, i, null];
                                    var o =
                                        t[
                                            (r.query
                                                ? r.query.index.name
        ...
        (tr.prototype._transaction = function (e, t, n) {
            ...
            var s = function i(o, a, u, s, c) {
                return _e.resolve().then(function () {
                    ...
                    if (
                        ((t.explicit = !0), (e = { trans: t, transless: e }), s)
                    )
    ...
    function tr(e, t) {
        ...
        (c.dbReadyPromise = new _e(function (e) {
                    ...
                    tr.vip(function () {
                        ...
                        e.openComplete
                            ...
                            : (i(n),
                              ...
                              r ||
                                  i(function e() {
                                      t.on.ready.unsubscribe(n),
                                          t.on.ready.unsubscribe(e);
                                  }));
                    });
                };
            })),
            ...
            (this.WhereClause =
                ((s = this),
                pt(Tt.prototype, function (e, t, n) {
                    if (
                        ((this.db = s),
                        (this._ctx = {
                            table: e,
            ...
            this.on("blocked", function (e) {
                !e.newVersion || e.newVersion < e.oldVersion
                    ? console.warn(
                          "Dexie.delete('".concat(o.name, "') was blocked")
                      )
                    : console.warn(
                          "Upgrade '"
                              .concat(
